...
#
# Actually: `unset VAR && exec binary` means the exec'd binary inherits
# the modified env (without the var). So the runner also won't see it
# via std::env::var. We need to pass it differently.
#
