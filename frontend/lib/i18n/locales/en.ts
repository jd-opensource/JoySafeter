  ...
  translation: {
    ...
    agents: {
      ...
      edit: {
        ...
        skills: 'Skills',
        secretRef: 'Model Configuration',
        selectSecret: 'Select model configuration',
        searchSecret: 'Search model secrets',
        noSecretMatch: 'No matching model secrets',
        createSecret: 'Create model configuration…',
    ...
    managed: {
      ...
      agents: {
        ...
        engineKind: 'Engine',
        engineKindDesc:
          'The engine determines the supported API protocols. Model configurations are filtered to compatible Provider and Protocol combinations.',
        ...
        basicSettingsDesc: 'Set the agent name, model secret, engine, and system prompt.',
      ...
      sessions: {
        ...
        goToVault: 'Go to MCP Credential Set',
        ...
        create: {
          ...
          optional: '(Optional)',
          advancedOptions: 'Advanced Options',
          advancedSummary: 'Runtime environment, MCP credential sets, resources, memory, Git',
          ...
          manageVaults: 'Manage MCP Credential Sets',
          createVault: 'Create MCP credential set…',
          searchVault: 'Search MCP credential sets by name or ID',
          noVaults: 'No vaults available',
          noVaultMatch: 'No matching vaults',
          resources: 'Resources',
      ...
      vaults: {
        ...
        creating: 'Creating...',
        empty: 'No MCP credential sets yet.',
        archiveVault: 'Archive MCP Credential Set',
        archiveTitle: 'Archive MCP Credential Set',
        archiveDescription:
          'Are you sure you want to archive "{{name}}"? Credentials in this vault will no longer be available to agents.',
        deleteTitle: 'Delete MCP Credential Set',
        deleteDescription:
          'Are you sure you want to permanently delete "{{name}}"? This action cannot be undone.',
        backToVaults: 'Back to MCP Credential Sets',
        ...
        cred: {
          ...
          createDescription: 'Store a Bearer token for one MCP server in this credential set.',
          adding: 'Adding…',
          add: 'Add Credential',
      ...
      llm: {
        ...
        chooseEngineFirst: 'Choose an engine first to see compatible model configurations.',
        ...
        configurationLoadFailed: 'Failed to load compatible model configurations.',
        ...
        createConfiguration: 'Create model configuration',
        createDialogDescription:
          'Create an LLM model configuration or a generic secret for this project.',
        ...
        genericValue: 'Value',
        genericValuePlaceholder: 'Secret value',
        ...
        incompatibleWithSelectedEngine:
          'The current model configuration does not support the selected engine.',
        loadingCatalog: 'Loading LLM compatibility catalog...',
        loadingConfigurations: 'Loading compatible model configurations...',
        modelConfiguration: 'Model Connection',
        nameRequired: 'Enter a configuration name.',
        noCompatibleConfigurations: 'No compatible model configurations',
        ...
        previousConfigurationIncompatible:
          'The previous model configuration is not compatible with this engine and was cleared. Choose another configuration or create one.',
        protocol: 'Protocol',
        provider: 'Model provider',
        providerProtocol: 'Provider / protocol',
        reselectConfiguration: 'Choose another model configuration',
        ...
        noConfigurationHint:
          'Do not bind a model configuration. The agent will not receive model credentials from Secrets.',
      },
      quickstart: {
        title: 'Quickstart',
        step: {
          ...
          configureVault: 'Configure MCP Credential Set',
          startSession: 'Start Session',
        },
        ...
        resourceKindMcpCredentialSet: 'MCP Credential Set',
        ...
        createThisVault: 'Create this MCP Credential Set',
        ...
        nextConfigureVault: 'Next: Configure MCP Credential Set',
        ...
        vaultCreateNew: 'Create New MCP Credential Set',
        vaultSomethingElse: 'Something Else',
        vaultNameQuestion: 'What would you like to name this MCP credential set?',
        vaultNamePlaceholder: 'e.g. production-mcp-credential-set',
        createVault: 'Create MCP Credential Set',
        trialRun: {
        ...
        errors: {
          ...
          createVaultFailed: 'Failed to create MCP credential set',
          ...
          vaultConfigMissing: 'MCP credential set configuration not found',
        ...
        stepComplete: {
          ...
          vaultCreated: 'MCP Credential Set Configured',
      ...
      search: {
        ...
        vaults: 'Search MCP credential sets by name, ID, or status',
