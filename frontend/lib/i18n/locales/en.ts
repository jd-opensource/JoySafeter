    ...
    managed: {
      ...
      sessions: {
        ...
        create: {
          ...
          noVaults: 'No MCP credential sets available',
          noVaultMatch: 'No matching MCP credential sets',
          resources: 'Resources',
      ...
      vaults: {
        ...
        subtitle: 'Manage MCP credential sets that give agents access to MCP servers and other tools.',
        ...
        createFailed: 'Failed to create MCP credential set. Please try again.',
        creating: 'Creating...',
