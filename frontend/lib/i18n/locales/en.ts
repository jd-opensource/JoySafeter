    ...
    managed: {
      ...
      skills: {
        ...
        collaborators: {
          title: 'Collaborators',
          subtitle:
            'Grant specific people access to this skill. Admins can manage collaborators, editors can edit, viewers can only view.',
          role: 'Role',
          add: 'Add',
          remove: 'Remove',
          removeConfirm: 'Remove {{name}} as a collaborator on this skill?',
          empty: 'No collaborators yet.',
          searchPlaceholder: 'Search people by name or email...',
          alreadyAdded: 'Already a collaborator',
          adminOnly: 'Only the skill owner or an admin can manage collaborators.',
