    ...
    analytics: {
      ...
      kpi: {
        ...
        tooltips: {
          ...
          avgSteps: 'Average number of agent steps per task — requires step tracking (not yet available)',
        },
      },
      charts: {
        callsTrend: 'Call Trend',
        callsTrendSubtitle: 'Total vs error calls over time',
        callsTrendTooltip: 'Shows the number of agent tasks over time. Error calls are tasks that ended with a failed status.',
        engineShare: 'Engine Distribution',
        engineShareSubtitle: 'Calls by agent engine',
        engineShareTooltip: 'Distribution of tasks by the engine type configured on each agent (e.g. Claude, Codex).',
        tokenTrend: 'Token Usage',
        tokenTrendSubtitle: 'Input vs output tokens over time',
        tokenTrendTooltip: 'Aggregated input and output token consumption from all sessions in each time bucket.',
        latencyTrend: 'Latency',
        latencyTrendSubtitle: 'Average duration and TTFT over time',
        latencyTrendTooltip: 'Average task execution time per time bucket. TTFT (Time To First Token) requires trace data.',
        inputTokens: 'Input',
        outputTokens: 'Output',
        totalCalls: 'Total',
        errorCalls: 'Errors',
