    ...
    managed: {
      ...
      environments: {
        ...
        egressAllowedPathsHint:
          'One path per line. A trailing / means prefix match (everything under it); otherwise exact match (that endpoint only). Leave empty to allow the entire base URL path. Restricting this prevents access to unauthorized endpoints.',
        ...
        egressAuthHint: 'Choose how the outbound credential is assembled.',
