    ...
    managed: {
      ...
      sessions: {
        ...
        create: {
          ...
          optional: '(Optional)',
          advancedOptions: 'Advanced Options',
          advancedSummary: 'Runtime environment, vaults, resources, memory, Git',
          ...
          searchVault: 'Search vaults by name or ID',
      ...
      environments: {
        ...
        egressSearchCredential: 'Search secrets',
        egressNoCredentialFound: 'No matching secrets',
      ...
      quickstart: {
        ...
        step: {
          ...
          chooseSecret: 'Choose Model Configuration',
