const en = {
  translation: {
    ...
    runs: {
      title: 'Run Monitor',
      description: 'Track active and recent agent runs and task executions.',
      ...
      executionEmptyDesc: 'Mission-dispatched executions will appear here.',
      linkedMission: 'Mission',
      viewInMissions: 'View in Task Board',
      viewInRunCenter: 'View in Run Monitor',
      dispatchedToast: 'Mission dispatched',
      dispatchedToastLink: 'Go to Run Monitor',
      dispatch: 'Dispatch',
      dispatching: 'Dispatching...',
      statusDispatched: 'Dispatched',
      statusApprovalWait: 'Approval Wait',
      pastExecutions: 'Past Executions',
      pastExecutionsCount: '{{count}} past execution(s)',
      pastExecutionsLink: 'View in Run Monitor',
      ...
      filteredByMission: 'Filtered by mission',
      clearFilter: 'Clear',
      notLinkedToMission: 'Not linked to a mission — actions unavailable',
    },
    missions: {
      stopRun: 'Stop Run',
