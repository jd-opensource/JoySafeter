  ...
  translation: {
    ...
    managed: {
      ...
      schedules: {
        ...
        searchPolicy: 'Search concurrency policies',
        noPolicyMatch: 'No matching concurrency policies',
        concurrencyHint:
        ...
        searchSessionMode: 'Search session modes',
        noSessionModeMatch: 'No matching session modes',
        sessionModeOption: {
          fresh: 'Fresh session',
          reuse: 'Reuse session',
        ...
        searchPinnedSession: 'Search pinned sessions',
        noPinnedSessionMatch: 'No matching sessions',
      ...
      triggers: {
        title: 'Triggers',
        subtitle: 'Configure webhooks that trigger a specific agent to run a prompt.',
        new: 'New Trigger',
        name: 'Name',
        namePlaceholder: 'Alert webhook',
        agent: 'Agent',
        selectAgent: 'Select an agent',
        secretRef: 'Secret reference',
        secretRefPlaceholder: 'Select or enter the vault key that stores WEBHOOK_SECRET',
        sessionMode: 'Session mode',
