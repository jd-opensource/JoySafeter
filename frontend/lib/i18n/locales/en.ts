const en = {
  translation: {
    ...
    managed: {
      ...
      schedules: {
        title: 'Schedules',
        subtitle: 'Run agents automatically on a recurring cron schedule.',
        new: 'New Schedule',
        createTitle: 'Create schedule',
        editTitle: 'Edit schedule',
        createDescription: 'Trigger an agent automatically on a recurring cron schedule.',
        ...
        description: 'Description',
        descriptionPlaceholder: 'Optional. What this schedule is for.',
        environment: 'Environment',
        ...
        concurrencyHint:
          'Concurrency policy governs overlap between scheduled (cron) fires only; a manual "Run now" always executes.',
        ...
        pinnedSessionHint: 'Only sessions for the selected agent are shown; titles are used when available.',
        selectAgentFirst: 'Select an agent before choosing a pinned session.',
        enabled: 'Enabled',
        enabledHint: 'Disabled schedules will not fire.',
        runNow: 'Run now',
        triggered: 'Triggered "{{name}}" — a run has started.',
        viewRuns: 'View runs',
        ...
        toggleFailed: 'Failed to update schedule. Please try again.',
        triggerFailed: 'Failed to trigger schedule. Please try again.',
        deleteFailed: 'Failed to delete schedule. Please try again.',
        policy: {
          allow: 'Allow overlap',
      ...
      search: {
        ...
        schedules: 'Search schedules by name, cron, or ID',
