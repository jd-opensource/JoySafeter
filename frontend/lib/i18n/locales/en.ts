    ...
    managed: {
      ...
      sessions: {
        ...
        networkPolicy: {
          ...
          readyAt: 'Ready at',
          empty: 'No running sandbox network policy yet. This session has no diagnosable sandbox, or the sandbox has been destroyed.',
        },
        tab: {
      ...
      networkPolicies: {
        ...
        subtitle: 'Inspect the latest Envoy/xDS policy state and failure audit for sandboxes. Successful paths keep only lightweight latest state.',
