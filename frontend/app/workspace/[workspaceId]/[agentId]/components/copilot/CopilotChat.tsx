          ...
          <div className="flex max-w-[85%] flex-col gap-2">
            ...
            {m.thoughtSteps && m.thoughtSteps.length > 0 && (
              <div className="space-y-2 rounded-xl border border-[var(--brand-100)] bg-[var(--brand-50)] p-3 duration-300 animate-in fade-in slide-in-from-top-2">
                <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[var(--brand-700)]">
                ...
                <div className="space-y-1.5">
                  {m.thoughtSteps.map((step, idx) => (
                    ...
                    >
                      <div className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-[var(--brand-100)] text-xs font-bold text-[var(--brand-600)]">
                        {step.index}
                      </div>
              ...
              <div className="space-y-2 rounded-xl border border-[var(--brand-100)] bg-[var(--brand-50)] p-3 duration-300 animate-in fade-in slide-in-from-top-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[var(--brand-700)]">
                    ...
                    {m.actions.length > 0 && (
                      <span className="rounded bg-[var(--brand-100)] px-1.5 py-0.5 text-xs font-normal normal-case text-[var(--brand-600)]">
