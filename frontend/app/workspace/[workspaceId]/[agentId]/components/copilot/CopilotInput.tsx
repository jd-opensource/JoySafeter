...
export function CopilotInput({
  ...
  const chipBase =
    'flex-shrink-0 text-sm px-2.5 py-1 rounded-full transition flex items-center gap-1 whitespace-nowrap'
    ...
    <div className="flex-shrink-0 border-t border-[var(--border-muted)] bg-[var(--surface-elevated)] px-1 py-0 backdrop-blur">
      ...
      <div className="mb-0.25 no-scrollbar flex min-h-0 items-center gap-1 overflow-x-auto pb-0.5">
        ...
        <div className="flex-shrink-0">
          ...
          >
            <SelectTrigger className="h-6 min-w-[5rem] max-w-[5.5rem] border-[var(--border)] px-2 py-0.5 text-xs text-[var(--text-secondary)]">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
      ...
      <div className="mt-2 flex items-center justify-between px-1 text-xs text-[var(--text-tertiary)]">
