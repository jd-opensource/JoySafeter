...
export function CollapsibleList<T>({
  ...
  expandKey,
  className = '',
  buttonClassName = 'flex items-center gap-1.5 text-xs text-[var(--brand-600)] hover:text-[var(--brand-700)] hover:bg-[var(--brand-50)] px-2 py-1 rounded transition-colors w-full text-left',
  expandText,
  collapseText,
