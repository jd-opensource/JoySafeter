                ...
                <div className="space-y-4 py-4">
                  ...
                  <div>
                    ...
                    <Select value={inviteRole} onValueChange={(v) => setInviteRole(v as any)}>
                      ...
                      <SelectContent className="z-popover min-w-[8rem] rounded-lg border border-[var(--border)] bg-[var(--surface-elevated)] py-1.5 shadow-xl [&_span[data-radix-select-item-indicator]]:left-2 [&_span[data-radix-select-item-indicator]]:flex [&_span[data-radix-select-item-indicator]]:h-5 [&_span[data-radix-select-item-indicator]]:w-5 [&_span[data-radix-select-item-indicator]]:items-center [&_span[data-radix-select-item-indicator]]:justify-center [&_span[data-radix-select-item-indicator]]:rounded-full [&_span[data-radix-select-item-indicator]]:bg-[var(--brand-50)] [&_span[data-radix-select-item-indicator]]:shadow-sm [&_svg]:h-3.5 [&_svg]:w-3.5 [&_svg]:stroke-[2.5] [&_svg]:text-[var(--brand-600)]">
