    ...
    >
      ...
      {!disabled && value.length < maxTags && (
        <Input
          ...
          disabled={disabled}
          className={cn(
            'h-6 min-w-[180px] flex-1 border-none bg-transparent p-0 font-sans text-sm font-medium placeholder:text-[var(--text-muted)] focus-visible:ring-0 focus-visible:ring-offset-0',
