...
>(({ className, style, onClick, ...props }, ref) => {
  ...
  return (
    <AlertDialogPrimitive.Overlay
      className={cn(
        'fixed inset-0 z-modal bg-black/40 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
        className,
      )}
    ...
    <AlertDialogPortal>
      <AlertDialogCloseContext.Provider value={closeContextValue}>
        ...
        <AlertDialogPrimitive.Content
          ...
          className={cn(
            // Base styles
            'fixed left-[50%] top-[50%] z-modal grid w-full max-w-md translate-x-[-50%] translate-y-[-50%] gap-4 overflow-hidden rounded-2xl bg-[var(--surface-elevated)] px-6 py-6 shadow-2xl duration-200',
            // Animation
