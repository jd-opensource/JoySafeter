...
export function OverviewDashboard() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h3 className="text-sm font-semibold text-[var(--text-secondary)] mb-3">Provider Health</h3>
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="rounded-lg border border-[var(--border-muted)] bg-[var(--surface-elevated)] p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-[var(--text-tertiary)]">Unhealthy</span>
            </div>
          ...
          <div className="rounded-lg border border-[var(--border-muted)] bg-[var(--surface-elevated)] p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-[var(--text-tertiary)]">Not Configured</span>
            </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-lg border border-[var(--border-muted)] bg-[var(--surface-elevated)] p-4">
          <p className="text-xs text-[var(--text-tertiary)] mb-1">Total Models</p>
          <p className="text-2xl font-bold text-[var(--text-primary)]">{overview.total_models}</p>
        </div>
        <div className="rounded-lg border border-[var(--border-muted)] bg-[var(--surface-elevated)] p-4">
          <p className="text-xs text-[var(--text-tertiary)] mb-1">Available Models</p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-xs font-semibold text-amber-800 mb-1">
                Recent credential validation failure: {overview.recent_credential_failure.provider_display_name}
              </p>
