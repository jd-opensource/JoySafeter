...
def upgrade() -> None:
    ...
    op.create_unique_constraint("uq_joysafeter_tasks_idempotency_key", "joysafeter_tasks", ["idempotency_key"])


def downgrade() -> None:
    op.drop_constraint("uq_joysafeter_tasks_idempotency_key", "joysafeter_tasks", type_="unique")
