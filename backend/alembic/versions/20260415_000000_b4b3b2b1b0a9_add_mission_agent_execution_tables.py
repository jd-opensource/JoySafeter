...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("parent_mission_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("missions.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("parent_execution_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("executions.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        "execution_snapshots",
        sa.Column("execution_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("executions.id", ondelete="CASCADE"), primary_key=True),
        sa.Column("last_seq", sa.BigInteger(), nullable=False, server_default="0"),
