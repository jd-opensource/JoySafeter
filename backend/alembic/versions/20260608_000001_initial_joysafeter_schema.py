...
def upgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
        ...
        op.create_index('permissions_entity_idx', 'permissions', ['entity_type', 'entity_id'], unique=False)
        op.create_index('permissions_user_entity_idx', 'permissions', ['user_id', 'entity_type', 'entity_id'], unique=False)
        op.create_index('permissions_user_entity_permission_idx', 'permissions', ['user_id', 'entity_type', 'permission_type'], unique=False)
        op.create_index('permissions_user_entity_type_idx', 'permissions', ['user_id', 'entity_type'], unique=False)
        op.create_index('permissions_user_id_idx', 'permissions', ['user_id'], unique=False)
        ...
        op.create_index('project_invitation_email_status_idx', 'project_invitation', ['email', 'status'], unique=False)
        op.create_index('project_invitation_expires_at_idx', 'project_invitation', ['expires_at'], unique=False)
        op.create_index('project_invitation_project_id_idx', 'project_invitation', ['project_id'], unique=False)
