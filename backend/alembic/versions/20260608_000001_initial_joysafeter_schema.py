...
def upgrade() -> None:
    ...
    op.create_index('audit_log_created_at_idx', 'security_audit_log', ['created_at'], unique=False)
    op.create_index('audit_log_event_status_idx', 'security_audit_log', ['event_status'], unique=False)
    op.create_index('audit_log_event_type_idx', 'security_audit_log', ['event_type'], unique=False)
    op.create_index('audit_log_user_event_idx', 'security_audit_log', ['user_id', 'event_type'], unique=False)
    op.create_index('audit_log_user_id_idx', 'security_audit_log', ['user_id'], unique=False)
    op.create_index(op.f('ix_security_audit_log_event_status'), 'security_audit_log', ['event_status'], unique=False)
