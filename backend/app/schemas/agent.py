...
class ConductorEngineKind(str, Enum):
    CLAUDE = "claude"
    CODEX = "codex"


class ConductorModelConfig(BaseModel):
    id: str
    speed: str = "standard"
...
class ConductorCreateAgentRequest(BaseModel):
    name: str
    engine_kind: ConductorEngineKind = ConductorEngineKind.CLAUDE
    model: Union[str, ConductorModelConfig, None] = None
...
class ConductorUpdateAgentRequest(BaseModel):
    version: Optional[int] = None
    name: Optional[str] = None
    engine_kind: Optional[ConductorEngineKind] = None
    model: Union[str, ConductorModelConfig, None] = None
    system: Optional[str] = Field(default=None, alias="system_prompt")
    description: Optional[str] = None
...
class ConductorAgentResponse(BaseModel):
    id: uuid.UUID
    type: str = "agent"
    name: str
    engine_kind: str
    model: Optional[ConductorModelConfig] = None
