...
def shape_episode_from_candidate(
    ...
    *,
    ...
    return SearchEpisodeItem(
        ...
        source_entry_ids=_as_str_list(md.get("source_entry_ids")),
        source_session_ids=_as_str_list(md.get("source_session_ids")),
        source_agent_ids=_as_str_list(md.get("source_agent_ids")),
