...
if TYPE_CHECKING:
    from app.everos.service.knowledge import KnowledgeExtractor
...
from app.everos.entrypoints.api.utils import extract_request_id
...
async def _parse_upload(
    ...
    """
    from app.everos.component.parser import parser_available  # Deferred: optional dep
