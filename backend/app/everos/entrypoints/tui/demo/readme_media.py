...
async def render_media(out_dir: Path) -> tuple[Path, Path]:
    ...
    from app.everos.entrypoints.tui.demo.app import DotSphereWidget
...
async def _export_frame(
    ...
    *,
    ...
    from app.everos.entrypoints.tui.demo.app import (
        SPHERE_FRAME_HEIGHT,
        SPHERE_FRAME_WIDTH,
        DotSphereWidget,
        EverOSDemoApp,
    )
    from app.everos.entrypoints.tui.demo.widgets.sphere import (
        build_dot_sphere,
