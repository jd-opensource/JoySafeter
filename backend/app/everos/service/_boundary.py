...
from app.everos.component.utils.datetime import from_timestamp, to_timestamp_ms
...
from app.everos.memory import CanonicalMessage, IngestResult, ToolCall
...
async def prepare_cells(
    ...
    *,
    ...
    if tail_canonical:
        # Re-arm idle detection: a non-empty tail means buffered content remains
        # after extracted cells, so idle flush must still see this session.
