...
pub struct RunnerMessage {
    #[prost(oneof = "runner_message::Payload", tags = "1, 2, 3, 4, 5, 6, 7, 8")]
...
pub mod runner_message {
    ...
    pub enum Payload {
        ...
        #[prost(message, tag = "8")]
        SetupResult(super::SandboxSetupResult),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RunnerReady {
    ...
    pub applied_runtime_config_generation: ::core::option::Option<i64>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SandboxSetupResult {
    #[prost(string, tag = "1")]
    pub setup_id: ::prost::alloc::string::String,
    #[prost(int64, tag = "2")]
    pub runtime_config_generation: i64,
    #[prost(enumeration = "SandboxSetupStatus", tag = "3")]
    pub status: i32,
    ...
    pub loaded_skills: ::prost::alloc::vec::Vec<LoadedSkill>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct LoadedSkill {
    ...
    #[prost(string, tag = "3")]
    pub skill_version_id: ::prost::alloc::string::String,
    #[prost(string, tag = "4")]
    pub skill_name: ::prost::alloc::string::String,
    #[prost(string, optional, tag = "5")]
    pub skill_source_type: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, tag = "6")]
    pub target: ::prost::alloc::string::String,
    #[prost(string, optional, tag = "7")]
    pub security_scan_id: ::core::option::Option<::prost::alloc::string::String>,
...
pub struct SkillArchive {
    ...
    pub target: ::prost::alloc::string::String,
    #[prost(string, optional, tag = "4")]
    pub skill_id: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "5")]
    pub skill_version: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "6")]
    pub skill_version_id: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "7")]
    pub skill_name: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "8")]
    pub skill_source_type: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "9")]
    pub security_scan_id: ::core::option::Option<::prost::alloc::string::String>,
    ...
    pub target_hash: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "11")]
    pub artifact_hash: ::core::option::Option<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl SandboxSetupStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "SANDBOX_SETUP_STATUS_UNSPECIFIED",
            Self::Applied => "SANDBOX_SETUP_STATUS_APPLIED",
            Self::Failed => "SANDBOX_SETUP_STATUS_FAILED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "SANDBOX_SETUP_STATUS_UNSPECIFIED" => Some(Self::Unspecified),
            "SANDBOX_SETUP_STATUS_APPLIED" => Some(Self::Applied),
            "SANDBOX_SETUP_STATUS_FAILED" => Some(Self::Failed),
            _ => None,
        }
    }
}
