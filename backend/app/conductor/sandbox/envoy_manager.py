...
class EnvoyConfig:
    ...
    socket_volume: str = "conductor-sockets"
    config_dir: str = "/tmp/conductor/envoy-config"
    envoy_network: str = "conductor-net"
    grpc_target_host: str = "host.docker.internal"
    grpc_target_port: int = 9090
    container_name: str = "conductor-envoy"
...
class EnvoyManager:
    ...
    Ported from conductor-sandbox/src/envoy.rs.
    """
