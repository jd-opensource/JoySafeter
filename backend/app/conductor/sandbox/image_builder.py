...
class ImageBuilder:
    ...
    Ported from conductor-sandbox/src/image_builder.rs.
    """

    def __init__(self, default_base: str = "joysafeter/cli-agent:latest"):
    ...
    async def build_environment_image(
        ...
        tag = f"conductor/env-{short_id}:v{version}"
