...
from app.conductor.runtime.adapter import HarnessAdapter, HarnessInput
...
class TaskRunner:
    ...
    async def _execute_task(self, task_id: uuid.UUID) -> None:
        ...
        try:
            ...
            from app.conductor.kernel.harness_input_builder import (
                build_harness_input,
    ...
    async def _build_harness_input(
        ...
        from app.conductor.runtime.adapter import SkillArchive
        import base64
    ...
    async def _run_harness_loop(
        ...
        from app.conductor.kernel.event_mapping import (
            map_harness_event,
            is_control_request,
        )
