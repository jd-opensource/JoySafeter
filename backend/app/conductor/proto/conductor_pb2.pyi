...
class RunnerReady(_message.Message):
    ...
    is_reconnect: bool
    active_task_id: str
    def __init__(self, runner_version: _Optional[str] = ..., available_providers: _Optional[_Iterable[str]] = ..., sandbox_id: _Optional[str] = ..., is_reconnect: bool = ..., active_task_id: _Optional[str] = ...) -> None: ...
...
class RunnerHarnessEvent(_message.Message):
    __slots__ = ("seq", "timestamp_ms", "text", "thinking", "tool_use", "tool_result", "error", "status", "log", "model_request_start", "model_request_end")
    ...
    def __init__(self, seq: _Optional[int] = ..., timestamp_ms: _Optional[int] = ..., text: _Optional[_Union[TextEvent, _Mapping]] = ..., thinking: _Optional[_Union[ThinkingEvent, _Mapping]] = ..., tool_use: _Optional[_Union[ToolUseEvent, _Mapping]] = ..., tool_result: _Optional[_Union[ToolResultEvent, _Mapping]] = ..., error: _Optional[_Union[ErrorEvent, _Mapping]] = ..., status: _Optional[_Union[StatusEvent, _Mapping]] = ..., log: _Optional[_Union[LogEvent, _Mapping]] = ..., model_request_start: _Optional[_Union[ModelRequestStartEvent, _Mapping]] = ..., model_request_end: _Optional[_Union[ModelRequestEndEvent, _Mapping]] = ...) -> None: ...
...
class OrchestratorMessage(_message.Message):
    ...
    def __init__(self, start: _Optional[_Union[StartTask, _Mapping]] = ..., cancel: _Optional[_Union[CancelTask, _Mapping]] = ..., input: _Optional[_Union[SendInput, _Mapping]] = ..., shutdown: _Optional[_Union[Shutdown, _Mapping]] = ..., setup: _Optional[_Union[SetupSandbox, _Mapping]] = ..., memory_update: _Optional[_Union[MemoryFileUpdate, _Mapping]] = ...) -> None: ...
...
class SetupSandbox(_message.Message):
    __slots__ = ("skills", "mcp_servers", "custom_tools", "setup_commands", "work_dir", "env", "secrets", "permission_mode", "provider", "model", "memory_system_prompt", "memory_mounts")
    ...
    def __init__(self, skills: _Optional[_Iterable[_Union[SkillArchive, _Mapping]]] = ..., mcp_servers: _Optional[_Iterable[_Union[McpConfig, _Mapping]]] = ..., custom_tools: _Optional[_Iterable[_Union[CustomTool, _Mapping]]] = ..., setup_commands: _Optional[_Iterable[str]] = ..., work_dir: _Optional[str] = ..., env: _Optional[_Mapping[str, str]] = ..., secrets: _Optional[_Mapping[str, str]] = ..., permission_mode: _Optional[str] = ..., provider: _Optional[str] = ..., model: _Optional[str] = ..., memory_system_prompt: _Optional[str] = ..., memory_mounts: _Optional[_Iterable[_Union[MemoryStoreMount, _Mapping]]] = ...) -> None: ...
...
class StartTask(_message.Message):
    __slots__ = ("task_id", "provider", "prompt", "system_prompt", "session_id", "model", "max_turns", "timeout_seconds", "env", "secrets", "mcp_servers", "repos", "work_dir", "skills", "allowed_tools", "disallowed_tools", "permission_mode", "setup_commands", "custom_tools")
    class EnvEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class RepoConfig(_message.Message):
    ...
    branch: str
    path: str
    def __init__(self, url: _Optional[str] = ..., branch: _Optional[str] = ..., path: _Optional[str] = ...) -> None: ...
