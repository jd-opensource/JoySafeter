...
from app.schemas.task import ConductorCreateTaskRequest as CreateTaskRequest, ConductorCreateTaskResponse as CreateTaskResponse, ConductorTaskResponse as TaskResponse
...
async def cancel_task(
    ...
    from app.core.lifespan import get_bridge_registry, get_redis_coordinator, get_session_broadcaster
...
async def task_stream(websocket: WebSocket, task_id: uuid.UUID):
    ...
    from app.core.lifespan import get_bridge_registry
