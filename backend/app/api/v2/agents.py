...
from app.api.v2.id_helpers import parse_agent_id
from app.core.database import get_db
from app.schemas.agent import (
    ConductorAgentResponse as AgentResponse,
    AgentVersionResponse,
    ConductorCreateAgentRequest as CreateAgentRequest,
    ConductorUpdateAgentRequest as UpdateAgentRequest,
)
from app.schemas.common import CursorPaginatedResponse as PaginatedResponse
from app.schemas.task import ConductorTaskResponse as TaskResponse
from app.schemas.session import SessionResponse
from app.services.agent_service import ConductorAgentService as AgentService, _split_packed_items
...
async def list_agent_sessions(
    ...
    def _session_to_response(session) -> SessionResponse:
        from app.api.v2.sessions import _session_to_response as _s2r
