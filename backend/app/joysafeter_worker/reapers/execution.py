...
async def execution_reaper_loop() -> None:
    ...
    while True:
        ...
        try:
            from app.joysafeter_shared.observation.otel.provider import get_broadcast_processor, get_persistence_processor
...
async def _reap_stale_executions() -> int:
    ...
    """
    async with AsyncSessionLocal() as db:
        from app.joysafeter_worker.services import ExecutionService
