...
CALLBACK_REDIRECT_CODES = frozenset(
    {
        "FEDERATION_ATTEMPT_INVALID",
        "FEDERATION_ATTEMPT_MISMATCH",
        "FEDERATION_ATTEMPT_EXPIRED",
        "FEDERATION_UPSTREAM_DENIED",
        "FEDERATION_UPSTREAM_UNAVAILABLE",
        "FEDERATION_ACCOUNT_LINK_REQUIRED",
        "FEDERATION_REGISTRATION_DISABLED",
        "FEDERATION_SESSION_ISSUE_FAILED",
        "FEDERATION_CALLBACK_FAILED",
    }
)
...
async def oauth_callback(
    ...
    try:
        ...
        error_code = (
            ...
            if federation_error.code in CALLBACK_REDIRECT_CODES
            else "FEDERATION_UPSTREAM_UNAVAILABLE"
        )
