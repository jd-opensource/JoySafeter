...
from app.joysafeter_shared.common.dependencies import get_current_user, require_org_role
...
from app.joysafeter_api.services import OrganizationService
...
class InviteMemberRequest(BaseModel):
    ...
    workspaceInvitations: Optional[list] = None  # @deprecated — kept for frontend backward compat, unused
