...
joysafeter_router.include_router(credentials_router, prefix="/credentials")
...
joysafeter_router.include_router(network_policies_router, prefix="/network-policies")
joysafeter_router.include_router(credential_groups_router, prefix="/credential-groups")
