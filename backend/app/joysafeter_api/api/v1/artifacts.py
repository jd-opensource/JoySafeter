...
from app.joysafeter_domain.agent.artifacts import ArtifactResolver, FileInfo, RunInfo
...
async def live_read_file(
    ...
    from app.joysafeter_api.services import SandboxManagerService, _sandbox_pool
