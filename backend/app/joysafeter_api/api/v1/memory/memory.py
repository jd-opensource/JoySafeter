...
from app.joysafeter_api.api.schemas import (
    BadRequestResponse,
...
from app.joysafeter_api.api.v1.memory.schemas import (
...
from app.joysafeter_api.services import MemoryService
...
async def optimize_memories(
    ...
    """Optimize user memories using the default summarize strategy."""
    from app.joysafeter_domain.agent.memory.manager import MemoryManager
    from app.joysafeter_domain.agent.memory.strategies.summarize import SummarizeStrategy
    from app.joysafeter_domain.agent.memory.strategies.types import MemoryOptimizationStrategyType
    ...
    try:
        ...
        from app.joysafeter_shared.model.utils.model_ref import parse_model_ref
        from app.joysafeter_api.services import ModelService
