...
from app.joysafeter_domain.schemas.common import CursorPaginatedResponse
...
async def list_files(
    ...
    scope_id: Optional[str] = Query(default=None, description="Filter by session: sesn_xxx"),
