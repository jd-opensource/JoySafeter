...
For local Docker sandboxes, see `app.joysafeter_domain.agent.backends.PydanticSandboxAdapter`.

Example:
    ```python
    from app.joysafeter_shared.tools.sandbox import create_sandbox
