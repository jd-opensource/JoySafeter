...
if TYPE_CHECKING:
    from app.joysafeter_domain.agent.backends.pydantic_adapter import RuntimeConfig
...
def create_modal_sandbox(
    *, sandbox_id: str | None = None, setup_script_path: str | None = None
    ...
    from app.joysafeter_shared.tools.sandbox.modal import ModalBackend
...
def create_runloop_sandbox(
    *, sandbox_id: str | None = None, setup_script_path: str | None = None
    ...
    from app.joysafeter_shared.tools.sandbox.runloop import RunloopBackend
...
def create_docker_sandbox(
    *,
    ...
    Example:
        ```python
        from app.joysafeter_shared.tools.sandbox.sandbox_factory import create_docker_sandbox
    ...
    if runtime is not None:
        if isinstance(runtime, str):
            from app.joysafeter_domain.agent.backends.pydantic_adapter import BUILTIN_RUNTIMES
