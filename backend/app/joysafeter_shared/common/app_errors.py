...
# ---------------------------------------------------------------------------
# JoySafeter Kernel Errors
# ---------------------------------------------------------------------------


class JoySafeterError(Exception):
    def __init__(self, message: str = ""):
        self.message = message
        super().__init__(message)


class JoySafeterNotFoundError(JoySafeterError):
    pass


class AlreadyExistsError(JoySafeterError):
    pass


class InvalidInputError(JoySafeterError):
    pass


class JoySafeterConflictError(JoySafeterError):
    pass


class DatabaseError(JoySafeterError):
    pass


class JoySafeterRedisError(JoySafeterError):
    pass


class SandboxError(JoySafeterError):
    pass
