...
class CredentialGroupService:
    ...
    async def create(self, request: Any, project_id: str) -> Any:
        return await self._transactions._mutate(
            lambda: self._uow.groups.create_group(request, project_id),
    ...
    async def get_or_raise(self, group_id: Any, project_id: str) -> Any:
    ...
    async def update(self, group_id: Any, request: Any, project_id: str) -> Any:
        return await self._transactions._mutate(
    ...
    async def restore(self, group_id: Any, project_id: str) -> Any:
        return await self._transactions._mutate(
    ...
    async def add_credential(self, group_id: Any, request: Any, project_id: str) -> Any:
        return await self._transactions._mutate(
            lambda: self._uow.groups.add_group_member(group_id, request, project_id),
