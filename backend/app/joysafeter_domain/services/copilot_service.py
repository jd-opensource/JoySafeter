...
from app.joysafeter_shared.common.app_errors import ModelConfigError
from app.joysafeter_domain.copilot.action_applier import apply_actions_to_graph_state
from app.joysafeter_domain.copilot.action_types import (
    CopilotResponse,
    GraphAction,
    GraphActionType,
)
from app.joysafeter_domain.copilot.action_validator import (
    extract_existing_node_ids,
    filter_invalid_actions,
    validate_actions,
)
from app.joysafeter_domain.copilot.agent import get_copilot_agent
from app.joysafeter_domain.copilot.exceptions import (
    CopilotAgentError,
    CopilotLLMError,
    CopilotValidationError,
)
from app.joysafeter_domain.copilot.message_builder import build_langchain_messages
from app.joysafeter_domain.copilot.response_parser import (
    expand_action_payload,
    extract_actions_from_agent_result,
    parse_thought_to_steps,
    try_extract_thought_field,
)
from app.joysafeter_domain.copilot.tool_output_parser import parse_tool_output
from app.joysafeter_domain.copilot.tools import reset_node_registry
...
class CopilotService:
    ...
    def __init__(
        ...
        Args:
            user_id: User ID for access scoping
    ...
    async def _stream_deepagents(
        ...
        from app.joysafeter_domain.copilot_deepagents.runner import stream_copilot_manager
    ...
    async def generate_actions(
        ...
        try:
            ...
            if mode == "deepagents":
                from app.joysafeter_domain.copilot_deepagents.runner import run_copilot_manager
