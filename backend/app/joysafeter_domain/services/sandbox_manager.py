...
from app.joysafeter_domain.agent.backends.constants import (
...
from app.joysafeter_domain.models.user_sandbox import UserSandbox
from app.joysafeter_domain.services.sandbox_pool import SandboxPool
...
class SandboxManagerService:
    ...
    async def ensure_sandbox_running(self, user_id: str) -> Any:
        ...
        """
        from app.joysafeter_domain.services import sandbox_handle
    ...
    async def _ensure_sandbox_running_locked(self, user_id: str) -> PydanticSandboxAdapter:
        ...
        try:
            ...
            from app.joysafeter_shared.utils.sandbox_paths import get_user_sandbox_host_dir
    ...
    def _force_remove_container(container_id: str) -> None:
        ...
        try:
            from app.joysafeter_domain.agent.backends.docker_check import get_docker_client
...
from app.joysafeter_domain.models.sandbox import JoySafeterSandbox  # noqa: E402
from app.joysafeter_domain.services.joysafeter_sandbox_state_machine import JoySafeterSandboxStateMachine  # noqa: E402
