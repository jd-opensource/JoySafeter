...
from app.joysafeter_shared.common.app_errors import InternalServiceError, InvalidRequestError
...
class McpClientService:
    ...
    async def _fetch_tools(
        ...
        from app.joysafeter_shared.utils.mcp_tool_builder import create_mcp_tools_from_definitions
