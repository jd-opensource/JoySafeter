...
from app.joysafeter_shared.model.utils import encrypt_credentials
...
from app.joysafeter_domain.models.execution import Artifact, Execution, ExecutionEvent
...
from app.joysafeter_domain.schemas.agent import CreateAgentRequest, UpdateAgentRequest
...
class AgentService(BaseService):
    ...
    async def list_agents(self, project_id: str) -> List[Agent]:
        return await self.agent_repo.list_by_project(project_id)

    async def list_agents_by_project(self, project_id: str) -> List[Agent]:
        return await self.agent_repo.list_by_project(project_id)
    ...
    async def create_agent(
        ...
        slug = base_slug
        suffix = 1
        # Check slug uniqueness by project
        while await self.agent_repo.get_by_project_and_slug(project_id, slug):
            suffix += 1
            slug = f"{base_slug}-{suffix}"

        # Create the Agent
        create_data = {
            "workspace_id": uuid.UUID(project_id),
...
# ---------------------------------------------------------------------------
# JoySafeter Agent Service
# ---------------------------------------------------------------------------

from datetime import datetime  # noqa: E402
from sqlalchemy import and_, func, delete as sa_delete  # noqa: E402

from app.joysafeter_domain.models.agent import JoySafeterAgent, JoySafeterAgentVersion  # noqa: E402
from app.joysafeter_domain.models.joysafeter_memory import JoySafeterSessionMemoryStore  # noqa: E402
from app.joysafeter_domain.models.session import JoySafeterSession, JoySafeterSessionEvent  # noqa: E402
from app.joysafeter_domain.models.task import JoySafeterTask  # noqa: E402
from app.joysafeter_domain.schemas.agent import (  # noqa: E402
    AgentResponse as JoySafeterAgentResponse,
    AgentVersionResponse as JoySafeterAgentVersionResponse,
    CreateAgentRequest as JoySafeterCreateAgentRequest,
    JoySafeterModelConfig,
    UpdateAgentRequest as JoySafeterUpdateAgentRequest,
)
...
class JoySafeterAgentService:
    ...
    async def delete_agent(
        ...
        if not force:
            from app.joysafeter_domain.models.task import JoySafeterTask, TERMINAL_STATUSES
