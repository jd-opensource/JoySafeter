...
from app.joysafeter_domain.models.task_activity import ActivityAuthorType, ActivityType, TaskActivity
from app.joysafeter_domain.repositories.task import TaskRepository
from app.joysafeter_domain.repositories.task_activity import TaskActivityRepository
...
class TaskActivityService:
    ...
    async def create_activity(
        ...
        *,
        ...
        task = await self.task_repo.get_by_id_and_project(task_id, project_id)
        if not task:
        ...
        if author_type == ActivityAuthorType.MEMBER and activity_type == ActivityType.COMMENT:
            ...
            from app.joysafeter_shared.utils.mentions import agent_mentions
    ...
    async def update_activity(
        ...
        *,
        ...
        activity = await self._get_owned_activity(activity_id, task_id, project_id, author_id)
        if not activity:
            return None
