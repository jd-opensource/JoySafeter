...
Manage user-level and project-level MCP servers.
"""
...
from app.joysafeter_domain.repositories.base import BaseRepository
...
class McpServerRepository(BaseRepository[McpServer]):
    ...
    Provide user/project-level CRUD operations for MCP servers.
    """
