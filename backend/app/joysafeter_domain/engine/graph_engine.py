...
class _GraphShim:
    ...
    def __init__(
        ...
        self.id = agent_id
        # Legacy attribute name kept for compatibility with runtime_prompt_template
        # which reads graph.workspace_id and maps it to "project_id".
    ...
    async def start(
        ...
        *,
        ...
        try:
            ...
            # ------------------------------------------------------------------
            from app.joysafeter_domain.graph.deep_agents.builder import build_deep_agents_graph
