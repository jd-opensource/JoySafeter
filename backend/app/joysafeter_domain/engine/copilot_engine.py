        ...
        *,
        ...
        try:
            ...
            if context.collector and model_name:
                from app.joysafeter_shared.observation.instrumentation.copilot_extractor import CopilotObservationExtractor

                copilot_extractor = CopilotObservationExtractor(context.collector, model_name)
                obs_start = time.monotonic()

            from app.joysafeter_domain.services.copilot_service import CopilotService
