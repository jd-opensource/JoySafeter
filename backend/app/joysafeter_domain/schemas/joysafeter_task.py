...
class JoySafeterCreateTaskRequest(BaseModel):
    ...
    # Agent identity: one-time auth code for API callers (optional).
    # When provided, JoySafeter exchanges it for a BotToken server-side.
    bot_auth_code: Optional[str] = None
