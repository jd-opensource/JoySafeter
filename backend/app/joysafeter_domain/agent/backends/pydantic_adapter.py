...
from app.joysafeter_domain.agent.backends.runtime_config import (
    BUILTIN_RUNTIMES,
    RuntimeConfig,
    get_builtin_runtime,
...
from app.joysafeter_domain.agent.backends.utils.command_executor import DANGEROUS_RE
from app.joysafeter_shared.utils.backend_utils import create_execute_response
...
class PydanticSandboxAdapter(SandboxBackendProtocol):
    ...
    **Pre-configured Runtimes:**
    ...
    Example:
        ```python
        from app.joysafeter_domain.agent.backends.pydantic_adapter import (
            PydanticSandboxAdapter,
            RuntimeConfig,
        )
