...
if TYPE_CHECKING:
    from app.joysafeter_domain.models.oauth_account import OAuthAccount  # pragma: no cover
    from app.joysafeter_domain.models.organization import Organization  # pragma: no cover
    from app.joysafeter_domain.models.user_sandbox import UserSandbox  # pragma: no cover
