...
# ---------------------------------------------------------------------------
# Conductor Sandbox Service (appended from app/conductor/services/sandbox_service.py)
# ---------------------------------------------------------------------------
...
from app.models.sandbox import ConductorSandbox  # noqa: E402
from app.utils.datetime import utc_now  # noqa: E402


class ConductorSandboxService:
    def __init__(self, db: AsyncSession):
        self.db = db
