...
class SkillLoadError(DomainError):
    ...
    def __init__(self, message: str = "技能加载失败", *, code: str = "SKILL_LOAD_FAILED",
                 data: Mapping[str, Any] | None = None, **kw: Any):
...
class SkillNotFoundError(NotFoundError):
    def __init__(self, message: str = "技能未找到", *, code: str = "SKILL_NOT_FOUND",
                 data: Mapping[str, Any] | None = None, **kw: Any):
        super().__init__(code=code, message=message, data=data, **kw)


class SkillPermissionDeniedError(AccessDeniedError):
    def __init__(self, message: str = "技能访问被拒绝", *, code: str = "SKILL_ACCESS_DENIED",
                 data: Mapping[str, Any] | None = None, **kw: Any):
        super().__init__(code=code, message=message, data=data, **kw)
...
class SkillFileWriteError(InternalServiceError):
    ...
    def __init__(self, message: str = "技能文件写入失败", *, code: str = "SKILL_FILE_WRITE_FAILED",
                 data: Mapping[str, Any] | None = None, **kw: Any):
        kw.setdefault("source", self._default_source)
        super().__init__(code=code, message=message, data=data, **kw)
