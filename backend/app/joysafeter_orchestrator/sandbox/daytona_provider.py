...
class DaytonaSandboxProvider(SandboxProvider):
    ...
    Daytona-backed JoySafeter sandbox provider.
    """
    ...
    async def create(
        ...
        **kwargs,
        ...
        body: dict = {
            "env": env,
            "labels": {**(labels or {}), "joysafeter": "true"},
            "target": self._target,
            "autoStopInterval": 15,
        ...
        if has_snapshot:
            ...
            eff_memory_mb = memory_mb or joysafeter_config.sandbox_memory_mb or 4096
            eff_disk_mb = disk_mb or joysafeter_config.sandbox_disk_mb or 20480
            body["cpu"] = 2
