...
async def test_aggregator_append(mock_node):
    ...
    mock_node.data["config"] = {"method": "append", "source_variables": ["scores"], "target_variable": "all_scores"}
...
async def test_aggregator_sum(mock_node):
    ...
    mock_node.data["config"] = {"method": "sum", "source_variables": ["scores"], "target_variable": "total_score"}
...
async def test_aggregator_latest(mock_node):
    ...
    mock_node.data["config"] = {"method": "latest", "source_variables": ["updates"], "target_variable": "latest_update"}
