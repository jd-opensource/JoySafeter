...
ENTRYPOINT /bin/sh -c '\
  ...
  su -p admin -c "\
    ...
    export GUNICORN_GRACEFUL_TIMEOUT=${GUNICORN_GRACEFUL_TIMEOUT}; \
    export GUNICORN_MAX_REQUESTS=${GUNICORN_MAX_REQUESTS}; \
    export GUNICORN_MAX_REQUESTS_JITTER=${GUNICORN_MAX_REQUESTS_JITTER}; \
